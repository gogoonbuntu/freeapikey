...
export const PROVIDER_CONFIG: Record<AIProvider, {
    ...
    gemini: {
        ...
        // Default limits (used for overall display; actual quota may vary per model)
        defaultLimits: { rpm: 10, rpd: 500, tpm: 250000, tpd: 50000000 },
        models: ['gemini-2.5-flash', 'gemini-2.5-flash-lite', 'gemini-2.5-pro'],
        modelLimits: {
            'gemini-2.5-flash':      { rpm: 10, rpd: 500,  tpm: 250000, tpd: 50000000 },
            'gemini-2.5-flash-lite': { rpm: 15, rpd: 1000, tpm: 250000, tpd: 50000000 },
            'gemini-2.5-pro':        { rpm: 5,  rpd: 50,   tpm: 250000, tpd: 50000000 },
        },
        costPer1MInput: 0.15,
    ...
    groq: {
        ...
        // Default limits (llama-3.1-8b); actual varies per model
